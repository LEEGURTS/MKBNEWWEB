interface MusicExpainSvgProps {
  onClick?: () => void;
  className?: string;
}

export const MusicExplainSvg: React.FunctionComponent<MusicExpainSvgProps> = ({
  onClick,
  className,
}) => {
  return (
    ...
    >
      <path d="M8.5 12.5L15.5 12.5" stroke="#222222" strokeLinecap="round" />
      <path d="M8.5 15.5L12.5 15.5" stroke="#222222" strokeLinecap="round" />
      <path
