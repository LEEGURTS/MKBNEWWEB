...
export const Contact: React.FunctionComponent = () => {
  ...
  return (
    <div
      className="fixed w-screen text-white font-pretendard font-medium overflow-hidden"
      style={{
        height: 100 * vh,
        background: "black",
      }}
    >
      <div className="flex items-center absolute z-40 left-[50%] -translate-x-[50%] top-[2em]">
        {Array(11)
          .fill(0)
          .map((_, idx) => {
            if (idx % 2 === 0) {
