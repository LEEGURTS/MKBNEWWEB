      ...
      <AnimatePresence>
        {isOpened && (
          ...
          >
            <div
              ref={innerRef}
              className="relative w-[80%] sm:w-[60%] lg:w-[40%] h-[30%] rounded-[0.5em] bg-[#253F4D] text-white p-6 "
            >
              <p className="font-bold text-[1.25em]">잠깐만요</p>
              <p className="absolute w-full text-[0.7em] whitespace-pre-line top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] p-6">
                {content}
              </p>
              <button
